...
function resource_sidemenu($selected_link = '') {
  ...
  foreach ($links as $key => $icon) {
    ...
    ?>
    <div class="<?php echo $class; ?>" style='position: relative; width: 105px'><span class='icon' id='<?php echo $icon_id; ?>'><img src='<?php echo $image; ?>' alt=""></span><span class='link'><a href='javascript:void(0)' class='show<?php echo $name; ?>' title="<?php echo $name; ?>"><?php echo $name; ?></a></span>
